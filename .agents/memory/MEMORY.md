...
- [Touch tooltip verification](touch-tooltip-verification.md) — assert computed visibility, not just open state; mobile hover/focus can keep a dismissed tooltip visible.
